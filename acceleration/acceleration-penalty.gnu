...
unset ttics
set title "0 to 99 mi/h acceleration time/distance curves" 
...
GNUTERM = "wxt"
## Last datafile plotted: "loco1600-accel.tsv"
plot "flirt500-accel.tsv" using ($2/1609.344):1 with lines title "2 FLIRT 75m, 500 pax", "loco500-accel.tsv" using ($2/1609.344):1 with lines title "F40PH and 3 coaches, 500 pax", "loco1600-accel.tsv" using ($2/1609.344):1 with lines title "HSP46 and 9 coaches, 1600 pax"
#    EOF
