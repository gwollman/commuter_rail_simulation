...
unset ttics
set title "Providence Line half-string diagram (Northbound Stoughton and Amtrak trips only)" 
...
GNUTERM = "wxt"
x = 0.0
## Last datafile plotted: "910.dat"
plot '900.dat' using 3:2 title "900", '902.dat' using 3:2 title "902", "904.dat" using 3:2 title "904", "906.dat" using 3:2 title "906", "908.dat" using 3:2 title "908", "amtk66.dat" using 3:2 title "Reg'l 66" with linespoints lw 3, "amtk2190.dat" using 3:2 title "Acela 2190" with linespoints lw 3, "amtk190.dat" using 3:2 title "Reg'l 190" with linespoints lw 3, "amtk2150.dat" using 3:2 title "Acela 2150" with linespoints lw 3, "910.dat" using 3:2 title "910"
#    EOF
