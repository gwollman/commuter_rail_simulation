...
unset ttics
set title "Providence Line half-string diagram (Southbound Stoughton and Amtrak trips only)" 
...
plot "amtk2151.dat" using 3:2 title "Acela 2151" with linespoints lw 3, "amtk2153.dat" using 3:2 title "Acela 2153" with linespoints lw 3, "amtk95.dat" using 3:2 title "Reg'l 95" with linespoints lw 2, "903.dat" using 3:2 title "903", "amtk2155.dat" using 3:2 title "Acela 2155" with linespoints lw 3, "905.dat" using 3:2 title "905", "amtk171.dat" using 3:2 title "Reg'l 171" with linespoints lw 2, "907.dat" using 3:2 title "907", "amtk2159.dat" using 3:2 title "Acela 2159" with linespoints lw 3, "amtk93.dat" using 3:2 title "Reg'l 93" with linespoints lw 2, "909.dat" using 3:2 title "909", "amtk173.dat" using 3:2 title "Reg'l 173" with linespoints lw 2
#    EOF
